...
[![Build Status](https://travis-ci.org/ahmdrz/goinsta.svg?branch=master)](https://travis-ci.org/ahmdrz/goinsta) [![GoDoc](https://godoc.org/github.com/brunocruzsilva/goinsta?status.svg)](https://godoc.org/github.com/brunocruzsilva/goinsta) [![Go Report Card](https://goreportcard.com/badge/github.com/brunocruzsilva/goinsta)](https://goreportcard.com/report/github.com/brunocruzsilva/goinsta) [![Gitter chat](https://badges.gitter.im/goinsta/community.png)](https://gitter.im/goinsta/community)
...
```
$ go get -u github.com/brunocruzsilva/goinsta
```
